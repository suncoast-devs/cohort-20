...
{
    // This class helps the controller so we can specify (and READ) the email and password
    ...
    public class SessionsController : ControllerBase
    {
        ...
        {
            // Look for a user in the system with the email address we are given in our loginUser
            var foundUser = await _context.Users.FirstOrDefaultAsync(user => user.Email == loginUser.Email);

            // If the password given matches then this is a valid login!
